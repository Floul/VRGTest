...
public class MostEmailedFragment extends Fragment {
    ...
    public static final int CATEGORY = Article.MOST_EMAILED_CATEGORY;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.most_emailed_rv);
        ...
        viewModel.getMostEmailedArticles().observe(this, new Observer<List<Article>>() {
            @Override
