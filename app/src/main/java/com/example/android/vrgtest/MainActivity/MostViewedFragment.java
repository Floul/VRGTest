...
public class MostViewedFragment extends Fragment {
    ...
    public static final int CATEGORY = Article.MOST_VIEWED_CATEGORY;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.most_viewed_rv);
        ...
        viewModel.getMostViewedArticles().observe(this, new Observer<List<Article>>() {
            @Override
